...
var AboutModal = Modal.extend({
    ...
    message: Settings.VERSION + '<br>' +
        ...
        '<span class="licensetype i18n"/> - Expires: <span class="licenseexpr"/><br/>'+
        ...
        '<div id="licensetable">'+
        '<h2 class="i18n">Unlicenced User Quota</h2><br/>'+
        '<div class="table-wrapper">'+
        '<div class="table-scroll">'+
        '<table>'+
        '<thead>'+
        '<tr>'+
        '<th><span class="text i18n ">Username</span></th>'+
        '<th><span class="text i18n">Logins Remaining</span></th>'+
        '</tr>'+
        '</thead>'+
        '<tbody>'+
        '<tr id="quotareplace"/>'+
        ...
        '</div>'+
        '</div>'+
        '<strong><a href="www.meteorite.bi/saiku-pricing" class="i18n" target="_blank">Order more licenses' +
        ' here</a></strong><br/>'+
