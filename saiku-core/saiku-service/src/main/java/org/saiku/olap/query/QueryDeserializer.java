...
public class QueryDeserializer {
  ...
  public IQuery unparse(@NotNull String xml, OlapConnection connection) throws Exception {
  ...
  @NotNull
  public SaikuCube getFakeCube(@NotNull String xml) throws Exception {
    SAXBuilder parser = new SAXBuilder();
  ...
  @NotNull
  public SaikuCube getCube(@NotNull String xml, OlapConnection con) throws Exception {
    this.connection = con;
    SAXBuilder parser = new SAXBuilder();
  ...
  private void setTotals(@NotNull IQuery q, @NotNull Element queryElement) {
  ...
  @NotNull
  private Properties getProperties(@NotNull Element queryElement) {
  ...
  private void manipulateQuery(@NotNull Element qmElement) throws OlapException {
    moveDims2Axis(qmElement);


  }

  private void moveDims2Axis(@NotNull Element qmElement) throws OlapException {
  ...
  private void processDimension(@NotNull Element dimension, String location) throws OlapException {
  ...
  @Nullable
  private Query createEmptyQuery(String queryName, String catalogName, @Nullable String schemaName, String cubeName)
      throws SQLException {
  ...
  @Nullable
  Axis.Standard getAxisName(@Nullable String location) {
    if (location != null) {
