...
public class ResultSetHelper {
  ...
  @NotNull
  private String read(@NotNull Clob c) throws SQLException, IOException {
  ...
  public String getValue(@NotNull ResultSet rs, int colType, int colIndex) throws SQLException, IOException {
    String value = "";
