...
public class OlapDataSourceStepsdef {
  ...
  public void givenAServerHasNoAvailableDataSources() throws IOException {
  ...
  public void there_are_data_sources_registered_on_the_server( int datasources ) throws IOException {
    List<String> l = new ArrayList<String>();
    l.add( "test" );
    l.add( "foodmart" );
    data.createDataSources( l );
  ...
  public void i_load_one_data_source() throws IOException, SaikuOlapException {
      List<String> l = new ArrayList<String>();
      l.add( "foodmart" );
      data.createDataSources( l );
      data.loadsingle();
  ...
  public void when2NewDataSourcesArePassedIntoTheServerAsAList() {
    List<String> l = new ArrayList<String>();
    l.add( "test" );
    l.add( "foodmart" );
  ...
  private void assertNotNull( Throwable caught ) {

  }

  @Then( "the server should throw an exception" )
  public void thenTheServerShouldThrowAnException() throws IOException {
    data.createInvalidDataSources();
  }

  @Then( "a SaikuServiceException should be thrown" )
  public void thenASaikuServiceExceptionShouldBeThrown() throws IOException {
    throwable.expect( SaikuOlapException.class );
    data.load();
  }
